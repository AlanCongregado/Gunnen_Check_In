...
-- Capacity guard for reservations (null capacity = unlimited)
...
begin
  ...
  -- null capacity = unlimited, skip check
...
-- Athlete Metrics View (14-day at-risk threshold)
...
select
    ...
    case
        ...
        when as_stats.last_attendance < now() - interval '14 days' or as_stats.last_attendance is null then 'At Risk'
        else 'Regular'
